...
public class QueryExpansion {
  ...
  public String expandedQuery() throws IOException {
    for (int i = 0; i < fbDocs; i++) {
      // System.out.println("this exp is " + Math.exp(this.qryResult.docScores.getDocidScore(i)));
      ...
      while (keyIte.hasNext()) {
        ...
        score += this.defaultScore.get(key) * Math.exp(this.qryResult.docScores.getDocidScore(i));
